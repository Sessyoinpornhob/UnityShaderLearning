Shader "ZD/L09/Cubemap_c" {
//shader路径名
    Properties {
        _Normalmap ("法线贴图", 2D) = "bump" {}
        _FresnelPow ("菲涅尔强度", Range(0, 2)) = 0.3826087
        _CubeMap ("CubeMap", Cube) = "_Skybox" {}
        _CubeMapLOD ("CubeMap强度", Range(1, 6)) = 2
        _EnvSpecInt ("环境光镜面反射强度", Range(0, 7)) = 2
    }
    //材质面板参数
    SubShader {
        Tags {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                //光照模型
                float3 var_Cubemap = texCUBElod(_CubeMap, float4(vrDirWS, _CubeMapLOD));
