...
////// Emissive:
                ...
                float3 node_4495 = ((_color0_var.rgb*step(_line01_var,node_671))+((step(node_671,_line01_var)-node_4020)*_color1_var.rgb)+(node_4020*_color2_var.rgb)); // 直接光照
                float3 emissive = node_4495;
