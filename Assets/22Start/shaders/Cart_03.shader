...
////// Emissive:
                ...
                float3 emissive = (((_color0_var.rgb*step(_line01_var,node_671))+((step(node_671,_line01_var)-node_4020)*_color1_var.rgb)+(node_4020*_color2_var.rgb))+((_MatCap_var.rgb*_MatcapPow_var)*pow((dot(i.normalDir,halfDirection)*0.5+0.5),_MatcapRange_var)));
